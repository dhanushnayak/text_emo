...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        lr =  Pipeline([('cv',TfidfVectorizer(ngram_range=(1,4),max_df=10,min_df=1)),('lr',LogisticRegression(C=c))])
        ...
        if tracking_url_type_store != "file":
            ...
            mlflow.sklearn.log_model(lr, "model", registered_model_name="LogisticTextModel")
        else:
